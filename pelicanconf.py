...
COMPETENCE2 = (
	'Analyser les objectifs et les modalités d’organisation d’un projet (en cour d\acquis)',
        'Planifier les activités (acquis)',
        'Évaluer les indicateurs de suivi d’un projet et analyser les écarts (en cour d\'acquis)',
        )
